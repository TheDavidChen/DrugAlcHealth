...
```{r}
fullhealth_lm <-
  lm(DrugMortalityRate ~ HealthExpenditure + PercentBachelor + PovertyPctAll + UnemploymentRate,
     data = HealthData_region)
...
```{r}
subsets <-
  regsubsets(DrugMortalityRate ~ HealthExpenditure + PercentBachelor + PovertyPctAll + UnemploymentRate,
     data = HealthData_region, nbest = 5)
plot(subsets)
