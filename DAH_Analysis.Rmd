...
First we wanted to conduct a PCA to see how mcuh the dataset could be reduced. We first removed categorical variables and dummy variables (the region variables), as well as variables that could be calculated through the other variables (Most notably DrugDeaths and DrugMortalityRate). Then, as Population and crude rates are included, direct values such as number of Unemployed are removed. 
```{r}
HealthData_pca <- 
  HealthData_region %>%
